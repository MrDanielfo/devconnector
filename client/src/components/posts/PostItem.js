...
const PostItem = ({deletePost, addLike, deleteLike, post: {_id, text, name, avatar, user, likes, comments, date}, auth}) => {
    return (
        <div className="post bg-white p-1 my-1">
            ...
            <div>
                ...
                <button onClick={e => deleteLike(_id)} type="button" className="btn btn-light">
